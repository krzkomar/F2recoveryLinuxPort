...
int  CritterHeal( Obj_t *dude, int damage );
int  CritterPoisoned( Obj_t *dude );
int  CritterPoisonInc( Obj_t *dude, int val );
int  CritterPoisonEv( Obj_t *dude, MsgLine_t *MsgLine );
int  CritterRadiated( Obj_t *dude );
int  CritterRadInc( Obj_t *dude, int Val );
...
void CritterUnk41();
int  CritterUnk42();
int  CritterKnockDownEv( Obj_t *dude, void * );
