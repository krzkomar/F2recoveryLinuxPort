...
void IntpPushPtrStack( char *Base, int *pIdx, void *data );
...
void IntpStringDeRef( Intp_t *scr, short opcode, int Idx );
...
char *IntpGetArg( Intp_t *scr, char flg, int Idx );
char *IntpGetString( Intp_t *scr, int Idx );
void IntpNegArg( Intp_t *scr, char *Idx );
void IntpValidate( Intp_t *scr );
void IntpValidateAll();
void IntpMergeString( Intp_t *scr );
