...
void CycleColorsInit()
{
    ...
    for( i = 0; i < 16; i++ ) ((char*)gCycPalWastes)[i] >>= 2;
    for( i = 0; i < 32; i++ ) ((char*)gCycPalScreens)[i] >>= 2;
    for( i = 0; i < 20; i++ ) ((char*)gCycPalFire)[i] >>= 2;
    for( i = 0; i < 20; i++ ) ((char*)gCycPalBurn)[i] >>= 2;
    for( i = 0; i < 20; i++ ) ((char*)gCycPalEE)[i] >>= 2;
